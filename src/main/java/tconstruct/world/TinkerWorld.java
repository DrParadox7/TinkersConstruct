    ...
    public void addLoot() {
        ...
        if (PHConstruct.balancedPartCrafting) {
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 1), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 2), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 3), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 4), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 5), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 6), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 9), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 10), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 11), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 12), 1, 3, 20));
            TinkerWorld.tinkerHousePatterns.addItem(
                    new WeightedRandomChestContent(new ItemStack(TinkerTools.woodPattern, 1, 13), 1, 3, 20));
        } else {
            for (int i = 0; i < 13; i++) {
                TinkerWorld.tinkerHousePatterns.addItem(
