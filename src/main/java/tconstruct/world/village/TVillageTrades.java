...
public class TVillageTrades implements IVillageTradeHandler {
    ...
    public TVillageTrades() {
        ...
        allowedIngredients.add(new ItemStack(TinkerTools.toolBenchWood, 3, 0));
        allowedIngredients.add(new ItemStack(TinkerTools.toolBenchWood, 3, 1));
        allowedIngredients.add(new ItemStack(TinkerTools.toolBenchWood, 3, 5));
        allowedIngredients.add(new ItemStack(TinkerTools.toolBenchWood, 3, 10));
