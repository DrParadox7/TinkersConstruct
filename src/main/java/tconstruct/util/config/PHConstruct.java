...
public class PHConstruct {
    ...
    public static void initProps(File location) {
        ...
        repairPerXp = config.get("Balance", "Repair value provided per xp point", 20, "Set to 0 to disable")
                .getInt(20);
        ...
        experimentalBackports = config.get("Experimental", "Enable experimental backports", true)
                .getBoolean(true);
