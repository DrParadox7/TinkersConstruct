...
public class GuiButtonMold extends GuiButton {
    ...
    public MoldGuiElement element;
    private static ResourceLocation background;

    public GuiButtonMold(int id, int posX, int posY, int texX, int texY, String domain, String tex, MoldGuiElement e) {
