...
public class TinkerToolEvents {
        ...
        if (!event.player.worldObj.isRemote) {
            ...
            if (item == Item.getItemFromBlock(TinkerTools.craftingSlabWood) && event.crafting.getItemDamage() == 4) {
                ...
                for (int i = 0; i < event.craftMatrix.getSizeInventory(); i++) {
                    ...
                    if (stack.getItem() == Item.getItemFromBlock(TinkerTools.toolBenchWood)
    ...
    private void handlePaper(NBTTagCompound toolTag, ToolCore tool) {
        ...
        if (toolTag.getInteger("Head") == TinkerTools.MaterialID.Paper
                || toolTag.getInteger("Handle") == TinkerTools.MaterialID.Paper
                || toolTag.getInteger("Accessory") == TinkerTools.MaterialID.Paper
                || toolTag.getInteger("Extra") == TinkerTools.MaterialID.Paper) modifiers++;
