...
public class ToolProxyClient extends ToolProxyCommon {
    ...
    void registerManualRecipes() {
        ...
        MantleClientRegistry.registerManualSmallRecipe(
                "toolstation", new ItemStack(TinkerTools.toolBenchWood, 1, 0), null, pattern, null, workbench);
        MantleClientRegistry.registerManualSmallRecipe(
                "partcrafter", new ItemStack(TinkerTools.toolBenchWood, 1, 1), null, pattern, null, log);
        MantleClientRegistry.registerManualSmallRecipe(
                "patternchest", new ItemStack(TinkerTools.toolBenchWood, 1, 5), null, pattern, null, chest);
        MantleClientRegistry.registerManualSmallRecipe(
                "stenciltable", new ItemStack(TinkerTools.toolBenchWood, 1, 10), null, pattern, null, plank);
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == ToolProxyCommon.moldingTableID)
            return new MoldingTableGui(
                    player.inventory, (MoldingTableLogic) world.getTileEntity(x, y, z), world, x, y, z);
    ...
    void addMoldButtons() {
        ...
        for (int[] icon : icons) {
            ...
            if (icon.length == 0) {
                addMoldButton(0, 0, -1);
            } else addMoldButton(icon[0], icon[1], i++);
        }
    }
