...
import tconstruct.tools.gui.MoldingTableGui;
...
import tconstruct.tools.gui.ToolBenchGui;
...
public class ToolProxyClient extends ToolProxyCommon {
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == ToolProxyCommon.moldingTableID) return new MoldingTableGui(
                player.inventory,
                (MoldingTableLogic) world.getTileEntity(x, y, z),
                world,
                x,
                y,
                z);
