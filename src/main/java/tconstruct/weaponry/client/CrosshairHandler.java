...
public class CrosshairHandler {
    ...
    private static ResourceLocation crossHairSquare = new ResourceLocation(
            Reference.RESOURCE,
            "textures/gui/Crosshair.png");
    private static ResourceLocation crossHairTip = new ResourceLocation(
            Reference.RESOURCE,
            "textures/gui/Crosshair2.png");
    private static ResourceLocation crossHairWeird = new ResourceLocation(
            Reference.RESOURCE,
            "textures/gui/Crosshair3.png");
    private static ResourceLocation crossHairSpike = new ResourceLocation(
            Reference.RESOURCE,
