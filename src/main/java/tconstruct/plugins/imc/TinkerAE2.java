...
public class TinkerAE2
{
    ...
    private static List<String> spatialIOToolLogics = Arrays.asList("CraftingStationLogic", "FrypanLogic", "PartBuilderLogic", "PatternChestLogic", "StencilTableLogic", "ToolForgeLogic", "ToolStationLogic", "ToolBenchLogic", "MoldingTableLogic");
