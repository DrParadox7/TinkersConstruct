    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (PHConstruct.moltenStone)
            FluidType.registerFluidType("Stone", Blocks.stone, 0, 800, TinkerSmeltery.moltenStoneFluid, true);
                ...
                .registerFluidType("Stone", TinkerTools.craftedSoil, 1, 800, TinkerSmeltery.moltenStoneFluid, true);
        ...
        TinkerSmeltery.ceramicPattern = new CeramicPattern("mold_", "materials/")
                .setUnlocalizedName("tconstruct.CeramicPattern");
    ...
    private void registerIngotCasting(FluidType ft, String name) {
        ...
        for (ItemStack ore : OreDictionary.getOres(name)) {
            tableCasting.addCastingRecipe(
                    ...
                    false,
                    50);
            if (!PHConstruct.removeGoldCastRecipes && !PHConstruct.steelPatterns) tableCasting.addCastingRecipe(
                    pattern,
                    new FluidStack(TinkerSmeltery.moltenGoldFluid, TConstruct.ingotLiquidValue * 2),
                    new ItemStack(ore.getItem(), 1, ore.getItemDamage()),
                    false,
