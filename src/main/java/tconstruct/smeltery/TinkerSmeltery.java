...
public class TinkerSmeltery {
    ...
    public static Block moltenNetherrack;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        TinkerSmeltery.fluids = new Fluid[] {
            ...
            TinkerSmeltery.moltenNetherrackFluid,
        };
        ...
        TinkerSmeltery.ceramicPattern =
                new CeramicPattern("mold_", "materials/").setUnlocalizedName("tconstruct.CeramicPattern");
        ...
        for (int i = 0; i < patternTypes.length; i++) {
            TConstructRegistry.addItemStackToDirectory(
                    patternTypes[i] + "Cast", new ItemStack(TinkerSmeltery.ceramicPattern, 1, i));
        }
    ...
    private void addRecipesForTableCasting() {
        ...
        if (PHConstruct.steelPatterns) {
            tableCasting.addCastingRecipe(
                    ...
                    new FluidStack(TinkerSmeltery.moltenSteelFluid, TConstruct.ingotLiquidValue * 2),
                    80);
            tableCasting.addCastingRecipe(
                    gemcast,
                    new FluidStack(TinkerSmeltery.moltenSteelFluid, TConstruct.ingotLiquidValue * 2),
        ...
        tableCasting.addCastingRecipe(
                ...
                new FluidStack(TinkerSmeltery.moltenNetherrackFluid, TConstruct.ingotLiquidValue / 4),
                ingotcast,
                80); // netherrack
    ...
    protected void addRecipesForBasinCasting() {
        ...
        basinCasting.addCastingRecipe(
                ...
                100);
        basinCasting.addCastingRecipe(
                new ItemStack(TinkerSmeltery.smelteryNether, 1, 4),
                new FluidStack(TinkerSmeltery.moltenNetherrackFluid, TConstruct.ingotLiquidValue),
                null,
                true,
                100); // searedNether
        // NetherCobblestone
        basinCasting.addCastingRecipe(
                new ItemStack(TinkerSmeltery.smelteryNether, 1, 5),
                new FluidStack(TinkerSmeltery.moltenNetherrackFluid, TConstruct.chunkLiquidValue),
                new ItemStack(Blocks.cobblestone),
                true,
                100);
        basinCasting.addCastingRecipe(
    ...
    protected static void addRecipesForSmeltery() {
        ...
        if (!PHConstruct.steelPatterns) {
            Smeltery.addMelting(
                    gold, new ItemStack(TinkerTools.blankPattern, 4, 2), -50, TConstruct.ingotLiquidValue * 2);
        } else {
            Smeltery.addMelting(
                    steel, new ItemStack(TinkerTools.blankPattern, 4, 2), -50, TConstruct.ingotLiquidValue * 2);
        }
        Smeltery.addMelting(
