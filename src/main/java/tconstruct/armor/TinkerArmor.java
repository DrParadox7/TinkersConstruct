        ...
        ModifyBuilder.registerModifier(
                new TravelModDoubleJump(
                        ...
                        new ItemStack[] { new ItemStack(Items.ghast_tear), new ItemStack(TinkerWorld.slimeGel, 1, 1),
                                new ItemStack(Blocks.piston) }));
        // ModifyBuilder.registerModifier(new AModInteger(4, "Moss", EnumSet.of(ArmorPart.Legs, ArmorPart.Feet,
        // ArmorPart.Chest, ArmorPart.Head), new ItemStack[] { new ItemStack(TinkerTools.materials, 1, 6) }, 3,
        // "\u00a72", StatCollector.translateToLocal("modifier.tool.moss")));
